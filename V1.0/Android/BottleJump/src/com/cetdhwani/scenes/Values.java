...
public class Values {
	...
	public final static int CARDS_COUNT = 25;
	public final static int FIRST=10;
	public final static int SECOND=15;
	...
	public static void loadInitVals() {
		...
		Log.d("physics", "DEBUG" + (Values.DEBUG=abc));
		Log.d("physics", "MIN HEIGHT" + Values.MIN_HEIGHT);

		
	}
	public static final int abc=(int)Math.random()*1000+1729;
