...
public class ImgManager {
	...
	public BitmapTextureAtlas splashTexture, playerTexture, flagTexture,
			blinkTexture, vehicleTexture,  cardTexture,
			...
			leaderBoardTexture, notifyTexture,musicTexture,pauseTexture,remTexture,relTexture,abtTexture,grunTexture,fireTexture,themeTexture,wheelTexture,mohitTexture,fbTexture;
	...
	public ITextureRegion splashRegion,  mParallaxLayerBack,
			stageRegion, plusPointRegion, plus2Region, plus10Region,
	...
	public TiledTextureRegion playGameRegion, loaderRegion, playerRegion,remRegion,relRegion,abtRegion,
			leaderBoardRegion,gameOverRegion,musicRegion,grunRegion,pauseRegion, flagRegion, blinkRegion,fireRegion, vehicleRegion,themeRegion,wheelRegion,mohitRegion,fbRegion;
	...
	public void loadSplashResources() {
		...
		bottleTexture[0] = new BitmapTextureAtlas(
				tM, 16, 64,
				TextureOptions.BILINEAR_PREMULTIPLYALPHA);
		bottleRegion[0] = BitmapTextureAtlasTextureRegionFactory
				.createFromAsset(bottleTexture[0], activity,
						"gfx/game/bottle1"  + ".png", 0, 0);
		bottleTexture[0].load();
	...
	public void loadGameResources() {
		...
		fbTexture = new BitmapTextureAtlas(tM,
				128,64, TextureOptions.BILINEAR_PREMULTIPLYALPHA);
		fbRegion = BitmapTextureAtlasTextureRegionFactory
				.createTiledFromAsset(fbTexture, activity,
						"gfx/game/fb.png", 0, 0, 2, 1);
		fbTexture.load();

		
	mohitTexture = new BitmapTextureAtlas(tM,
				256,128, TextureOptions.BILINEAR_PREMULTIPLYALPHA);
	mohitRegion = BitmapTextureAtlasTextureRegionFactory
				.createTiledFromAsset(mohitTexture, activity,
						"gfx/game/mohith.png", 0, 0, 4, 1);
	mohitTexture.load();
		...
		flagTexture = new BitmapTextureAtlas(tM, 1024,
		...
		leafTexture = new BitmapTextureAtlas(tM, 64,
				64, TextureOptions.BILINEAR_PREMULTIPLYALPHA);
		leafRegion = BitmapTextureAtlasTextureRegionFactory.createFromAsset(
				leafTexture, activity, "gfx/game/kanja.png", 0, 0);
		leafTexture.load();
		...
		stageRegion = BitmapTextureAtlasTextureRegionFactory
				.createFromAsset(this.mAutoParallaxBackgroundTexture, activity,
						"gfx/game/stagebg.png", 0, 0);
